...
clustering_recovering_bundle(name="", graph_name="relaxed") :: {
        ...
        tagger_check_neutrino(name="", trackfitting_config_file="", particle_dataset="", recombination_model="", perf=false, dl_weights="", dQdx_scale=0.1, dQdx_offset=-1000.0, clus_geom_helper="", dl_vtx_rerank=true, dl_vtx_top_k=5, dl_vtx_min_accept_score=4.0, dl_vtx_score_scale=1000.0, beam_window_low=0, beam_window_high=0, nu_skip_cosmic=false, nu_skip_cosmic_bundle=false, nu_skip_cosmic_bundle_min_length=0, dir_weak_use_score=false, mip_dqdx=null, mip_dqdx_median=null, proton_dir_vote=false, proton_dir_score_max=null, proton_dir_asym_min=null, endpoint_trim_retry=false, fit_vertex_min_seg_length=null, cathode_x=null, cathode_kink_xcut=null, cathode_wide_kink_angle=null, cathode_wide_kink_skirt=null, cathode_wide_kink_baseline=null, shower_topo_demote_len=null, iso_endpoint=false, iso_endpoint_min_length=null, iso_endpoint_max_xext=null, iso_endpoint_xext_frac=null, iso_endpoint_xext_quantile=null, iso_endpoint_tube_radius=null, iso_endpoint_min_aspect=null, v3_extension_guard=false, v3_extension_min_gain=null, cosmic_y_top_main=null, cosmic_y_top_strict=null, cosmic_y_top_loose=null, cosmic_y_small_piece=null, vertex_z_prior_scale=null, ssm_target_dir=null, ssm_absorber_dir=null, kine_fudge_factor=null, kine_recom_factor=null, kine_shower_fudge_factor=null, kine_shower_recom_factor=null, kine_proton_recom_factor=null, kine_plane_weights=null, kine_plane_asym_switch=null, kine_w_value=null, kine_shower_pdg_live=false, muon_dqdx_curve=null, sp_dedx_use_recomb_model=false, sp_mean_dedx_cut=null, dl_vtx_cut=null, skip_cosmic_companions=false, cosmic_companion_min_length=null, nu_fallback_demoted_mains=false, nu_per_bundle=false, nu_per_bundle_demoted_acts=false, nu_per_bundle_min_length=null, nu_selected_as_main=false, nu_selected_as_main_snapshot_all=false, sp_photon_flag=false, fit_exclusion=false, graph_endpoint_tol=null, oov_prototype_parity=false, first_seg_local_pca=null, other_seg_relaxed_accept=null, shower_topo_proto_dir=false, vertex_dir_use_fit_point=false, shower_traj_recheck_parity=false, main_vertex_require_descriptor=false, main_vertex_candidate_flag=false, cont_muon_dir3_30cm=false, track_comp_empty_abstain=false, shower_topo_reset=false, reclass_preserve_4mom=false, dir_track_median_local=false, examine_showers_vertex_by_index=false, fiducial=null, fv_tolerance=[], cosmic_consistent_fv=false, nue_sp_consistent_fv=false, sp_sce_correction=false, tagger_ordered_segment_sets=false, stem_endpoint_wcpt_parity=false, broken_muon_cluster_id_count=false, neutrino_type_bitmask=false, daughter_count_proto_main_vertex=false, daughter_count_proto_examine_showers=false, shower_pdg_from_start_segment=false, shower_pdg_from_shower_type=false, shower_pdg_exact_muon_test=false, pi0_id_shared_allocator=false, shower_flag_pdg_electron=false, shower_less_id_tiebreak=false, shower_endpoint_exclude_start_vertex=false, shower_endpoint_skip_orphan_vtx=false, shower_walk_visited_parity=false, track_pid_persist_dqdx=false, shower_reclass_dqdx_guard=false, shower_topo_dqdx_guard=false, reclass_never_computed_ke_floor=false, track_pid_persist_4mom=false, shower_proton_daughter_pion=false, shower_proton_daughter_pion_dissolve=false, muon_multi_proton_pion=false, track_pid_persist_dqdx_electron_guard=false, shower_connect_main_vertex_straight_guard=false, shower_traj_straight_guard=false, shower_absorb_track_guard=false, michel_stem_muon_rescue=false, shower_in_cascade_guard=false, shower_in_max_len=null, shower_in_mip_hi=null, shower_connect_from_vertices_straight_guard=false, shower_connect_start_seg_straight_guard=false, examine_direction_dirsign_shower_in_guard=false, daughter_shower_angle_reclass_straight_guard=false, shower_topo_reexam_straight_guard=false, sfv_kink_max=null, shower_nv_bridge_track=false, shower_nv_bridge_max_gap=null, shower_nv_main_pi_init=false, kine_drop_stray_satellites=false, kine_sat_min_energy=null, kine_sat_prox_max=null, kine_sat_angle_bad=null, kine_sat_angle_main=null, kine_sat_far_dis=null, kine_sat_axis_dis_cut=null, kine_sat_cont_kink=null, kine_sat_track_max_nseg=null, kine_sat_em_far_dis=null, michel_stem_michel_check=false, michel_stem_max_far_len=null, shower_stem_backfill=false, stem_backfill_max_len=null, stem_backfill_mip_lo=null, stem_backfill_mip_hi=null, stem_backfill_min_shower_len=null, shower_conn3_unreachable=false, conn3_unreachable_min_len=null, conn3_stitch_max=null, shower_dedup_start_seg=false, shower_traj_michel_stem=false, michel_stem_traj_min_len=null, michel_stem_traj_max_len=null, michel_stem_traj_mip_lo=null, michel_stem_traj_max_far_len=null, michel_stem_traj_min_kink_deg=null, shower_long_muon_keep_type=false, shower_bragg_protect_start_segment=false, shower_reclass_case_b_dqdx_guard=false, shower_accept_pid_guard=false, shower_pid_guard_min_len=null, shower_vote_track_pid_counts=false, shower_cone_absorb_guard=false, shower_detach_track_stem=false, shower_ghost_member_drop=false, shower_ghost_overlap_frac=null, shower_ghost_dqdx_ratio=null, shower_ghost_min_len=null, kine_charge_dedup=false, kine_charge_rebuild=false, kine_charge_track_ctx=false, kine_mass_rules=false, kine_hadronic_dqdx=false, kine_long_muon_mode=null, kine_long_muon_ratio_lo=null, kine_long_muon_ratio_hi=null, kine_mainvtx_used_guard=false, shower_hadronic_tag=false, shower_hadronic_min_len=null, shower_hadronic_scan_len=null, shower_hadronic_bin=null, shower_hadronic_r_cyl=null, shower_hadronic_r_core=null, shower_hadronic_growth_max=null, shower_hadronic_growth_bragg=null, shower_hadronic_bragg_ratio=null, shower_hadronic_stem_ratio=null, kine_count_orphan_tracks=false, kine_orphan_track_min=null, straight_cont_cross_cluster=false, sccc_bridge_body=false, sccc_max_gap=null, sccc_kink_max=null, sccc_gap_aligned=null, sccc_kink_tight=null, single_muon_proton_chain_veto=false, single_muon_long_muon_claim=false, pid_flag_reconcile=false, other_seg_empty_2d_guard=false, long_muon_stub_bridge=false, two_end_break=false, teb_min_len=null, teb_min_arm=null, teb_min_arm_pts=null, teb_stub_max=null, teb_accept_range=null, teb_rise_r1=null, teb_rise_r2=null, teb_abs_end_min=null, teb_dip_floor=null, teb_score_cap_r1=null, teb_score_cap_r2=null, teb_turn_angle=null, teb_turn_baseline=null, teb_turn_skirt=null, teb_turn_min_arm_frac=null, teb_chain_topology=false, teb_r3_turn=null, teb_r3_hot=null, teb_bragg_veto_turn=null, kink_walk_dqdx_stop=false, kink_break_protect=false, kink_dqdx_hot_ratio=null, fit_blob_coverage=null, fit_blob_coverage_defer=false, vertex_kink_snap=false, vks_radius=null, vks_min_dis=null, vks_angle=null, vks_margin=null, vks_collinear=null, vks_skirt=null, vks_baseline=null, vks_min_arm=null, vks_fit_miss=null, vks_hot_ratio=null, vks_carry_prong=null, vertex_junction_snap=false, vjs_radius=null, vjs_min_arm=null, vjs_min_prongs=null, vjs_collinear=null, vjs_fit_margin=null, vjs_fit_rms=null, vjs_override_kink_snap=false, vjs_min_move=null, esva_ignore_empty_2d=false, main_vertex_graph_audit=false, mvga_radius=null, mvga_dup_tol=null, mvga_dup_frac=null, mvga_dup_angle=null, mvga_bridge_mip=null, mvga_reconnect=null, mvga_stub=null, mvga_stub_pts=null, mvga_reseat_angle=null, mvga_satellite=null, mvga_interposed=false, mvga_interposed_angle=null, mvga_interposed_len=null, mvga_sat_dup_frac=null, mvga_interposed_deg1=false, mvga_splice_straighten=null, mvga_approach_collapse=null, mvga_straighten_radius=null, mvga_op1_radius=null, mvga_op1_dup_frac=null, mvga_op1_post=false, swap_orphan_dup_audit=false, mvga_proj_dup_frac=null, mvga_proj_dqdx_ratio=null, mvga_proj_angle=null, mvga_ac_veto_radius=null, mvga_ac_chord_max=null, mvga_ac_no_cascade=false, mvga_passthru=null, mvga_passthru_tol=null, mvga_interposed_fallback=false, mvga_interposed_fallback_min_angle=null, mvga_dup_starved_asym=null, mvga_dup_starved_mip=null, mvga_dup_starved_span=null, dl_vtx_cloud_no_exclusion=false, dl_vtx_dual_chain=false, dual_chain_mode=null, dual_chain_transfer=false, dual_chain_transfer_max=null, dual_chain_allow_cluster_swap=null, dual_chain_vtx_weight=null, dqdx_fit_keep_all_points=false, main_vertex_swap_apply=false, rough_path_probe=false, steiner_gap_penalty=null, sgp_dead_alpha=null, sgp_min_edge=null, sgp_sample_step=null, sgp_point_radius=null, sgp_weak_scale=null, sgp_weak_qref=null, sgp_edge_probe=false, sgp_max_sep=null, break_seg_orient=false, vertex_scoreboard=false, dl_vtx_harvest=false, traj_cover_probe=false, pr_find_other_rounds=null, other_seg_keep_isolated=false, other_seg_keep_isolated_min_points=null, other_seg_keep_isolated_min_length=null, other_seg_keep_isolated_min_nnf=null, other_seg_keep_isolated_len_admit=null, iso_snap_min_dir_mag=null, assoc_full_recluster=false, assoc_reassign_orphans=false, assoc_clear_on_merge=false, shower_absorb_unreachable_main=false, es3_stub_guard=false, es3sg_stub_max=null, es3sg_len_ratio=null, es3sg_ang3_min=null, es3sg_ang_ratio=null, es3sg_require_terminal=null, mvfit_robust=false, mvfit_main_only=null, mvfit_min_len=null, mvfit_rin_margin=null, mvfit_rout_frac=null, mvfit_rout_min=null, mvfit_rout_max=null, mvfit_angle=null, mvfit_min_pts=null, mvfit_min_aniso=null, mvfit_prior_range=null) :: {
            ...
            data: {
              ...
              // nu_selected_as_main (doc sbnd_xin/docs/pr/94 round 3): give the
              // SELECTED neutrino candidate the main-cluster PR treatment for
              // the duration of its own pass, even when it is a demoted main
              // (the nu_fallback_demoted_mains path, and every per-bundle
              // candidate).  Without it the candidate silently loses
              // examine_vertices_3, improve_vertex + fix_maps_shower_in_track_
              // out, main_cluster_initial_pair_vertices, break_two_end_dqdx and
              // the main-branch endpoint ordering, because the PR chain reads
              // main-ness from a flag ClusteringUnmergeBundle cleared (SBND
              // 18255/395148).  NOT gated on nu_per_bundle -- the legacy
              // fallback path has the same defect.  C++ default false; key
              // omitted when off => byte-identical config.
              + (if nu_selected_as_main then { nu_selected_as_main: true } else {})
              // nu_selected_as_main_snapshot_all (sbnd_xin/docs/75): closes a
              // gap in nu_selected_as_main's own guard -- the DL/SCN vertex
              // path can move Flags::main_cluster onto a DIFFERENT cluster
              // in the candidate's bundle mid-pass, which the narrow guard's
              // restore does not undo.  Snapshots and restores EVERY
              // cluster in {main_cluster} u other_clusters instead of just
              // the candidate's own pointer.  C++ default false; key
              // omitted when off => byte-identical config.
              + (if nu_selected_as_main_snapshot_all then { nu_selected_as_main_snapshot_all: true } else {})
              ...
              // graph_endpoint_tol (P8): tolerance for the add_segment
              // endpoint-consistency tripwire (WARN-only; the refusal knob
              // graph_endpoint_strict was removed doc 77 round 1, 2026-08-24
              // -- "must stay OFF", pr/30 P8/pr/86:450).  C++ default 0.3 cm.
              ...
              + (if fiducial != null then { fiducial: fiducial } else {})
              + (if std.length(fv_tolerance) > 0 then { fv_tolerance: fv_tolerance } else {})
              // cosmic_consistent_fv (sbnd_xin/docs/74 G1/G2): route the SAME
              // fiducial + fv_tolerance above into cosmic_tagger()'s
              // containment tests (its inside_fv lambda and the flag-1 vertex
              // test).  Requires "fiducial"; inert without it.  C++ default
              // false.  Key omitted when off => byte-identical.
              + (if cosmic_consistent_fv then { cosmic_consistent_fv: true } else {})
              // nue_sp_consistent_fv (sbnd_xin/docs/75): route the SAME
              // fiducial above into the nue/single-photon taggers'
              // containment tests (angular_cut, shower_to_wall,
              // bad_reconstruction_2/_2_sp).  Requires "fiducial"; inert
              // without it.  C++ default false.  Key omitted when off =>
              // byte-identical.
              + (if nue_sp_consistent_fv then { nue_sp_consistent_fv: true } else {})
              ...
              // doc pr/91 round 1 F1.  C++ default false.  Key omitted when off => byte-identical pre-fix config.
              + (if shower_endpoint_skip_orphan_vtx then { shower_endpoint_skip_orphan_vtx: true } else {})
              + (if shower_walk_visited_parity then { shower_walk_visited_parity: true } else {})
              ...
              // doc sbnd_xin/docs/pr/40 round 9 -- the rounds-7+8 straight-
              // track PID guard family + the B2 cross-cluster bridge.  C++
              // defaults false (scalars: C++ holds the active default,
              // sfv_kink_max 25 deg / shower_nv_bridge_max_gap 1.8 cm).
              // Keys omitted when off/null => byte-identical pre-round-9
              // config.
              + (if shower_connect_from_vertices_straight_guard then { shower_connect_from_vertices_straight_guard: true } else {})
              + (if shower_connect_start_seg_straight_guard then { shower_connect_start_seg_straight_guard: true } else {})
              + (if examine_direction_dirsign_shower_in_guard then { examine_direction_dirsign_shower_in_guard: true } else {})
              + (if daughter_shower_angle_reclass_straight_guard then { daughter_shower_angle_reclass_straight_guard: true } else {})
              + (if shower_topo_reexam_straight_guard then { shower_topo_reexam_straight_guard: true } else {})
              + (if sfv_kink_max != null then { sfv_kink_max: sfv_kink_max } else {})
              + (if shower_nv_bridge_track then { shower_nv_bridge_track: true } else {})
              + (if shower_nv_bridge_max_gap != null then { shower_nv_bridge_max_gap: shower_nv_bridge_max_gap } else {})
              // doc sbnd_xin/docs/pr/97 D1 -- deterministic main_pi sentinel in
              // shower_clustering_with_nv_from_vertices.  C++ default false =
              // legacy indeterminate read.  Key omitted when off => compiled
              // config byte-identical to pre-pr/97.
              + (if shower_nv_main_pi_init then { shower_nv_main_pi_init: true } else {})
              // doc sbnd_xin/docs/pr/92 -- stray-satellite drop from kine/PF.
              // C++ defaults false (scalars: C++ holds the active defaults,
              // 20 MeV / 8 cm / 60 deg / 45 deg / 90 cm / 30 cm / 25 deg).
              // Keys omitted when off/null => byte-identical pre-pr/92 config.
              + (if kine_drop_stray_satellites then { kine_drop_stray_satellites: true } else {})
              + (if kine_sat_min_energy != null then { kine_sat_min_energy: kine_sat_min_energy } else {})
              + (if kine_sat_prox_max != null then { kine_sat_prox_max: kine_sat_prox_max } else {})
              + (if kine_sat_angle_bad != null then { kine_sat_angle_bad: kine_sat_angle_bad } else {})
              + (if kine_sat_angle_main != null then { kine_sat_angle_main: kine_sat_angle_main } else {})
              + (if kine_sat_far_dis != null then { kine_sat_far_dis: kine_sat_far_dis } else {})
              + (if kine_sat_axis_dis_cut != null then { kine_sat_axis_dis_cut: kine_sat_axis_dis_cut } else {})
              + (if kine_sat_cont_kink != null then { kine_sat_cont_kink: kine_sat_cont_kink } else {})
              + (if kine_sat_track_max_nseg != null then { kine_sat_track_max_nseg: kine_sat_track_max_nseg } else {})
              + (if kine_sat_em_far_dis != null then { kine_sat_em_far_dis: kine_sat_em_far_dis } else {})
              ...
              + (if conn3_stitch_max != null then { conn3_stitch_max: conn3_stitch_max } else {})
              + (if shower_dedup_start_seg then { shower_dedup_start_seg: true } else {})   // doc pr/84 r3 S1.  C++ default false.  Key omitted when off => byte-identical pre-fix config.
              ...
              // doc pr/40 round 10.  C++ default false; key omitted when off =>
              // byte-identical pre-fix config.
              + (if shower_bragg_protect_start_segment then { shower_bragg_protect_start_segment: true } else {})
              // doc pr/93 round 3 -- C++ defaults false. Key omitted when off =>
              // byte-identical pre-fix config.
              + (if shower_reclass_case_b_dqdx_guard then { shower_reclass_case_b_dqdx_guard: true } else {})
              + (if shower_accept_pid_guard then { shower_accept_pid_guard: true } else {})
              + (if shower_pid_guard_min_len != null then { shower_pid_guard_min_len: shower_pid_guard_min_len } else {})
              + (if shower_vote_track_pid_counts then { shower_vote_track_pid_counts: true } else {})
              + (if shower_cone_absorb_guard then { shower_cone_absorb_guard: true } else {})
              // doc pr/93 round 4 -- C++ defaults false / null = C++ defaults
              // (50cm orphan floor; sccc 5cm/15deg base + 12cm/7.5deg aligned
              // tiers).  Keys omitted when off => byte-identical pre-fix config.
              + (if shower_detach_track_stem then { shower_detach_track_stem: true } else {})
              // doc pr/99 round 2.  C++ defaults false/0.7/0.25/10cm.  Keys omitted when off => byte-identical.
              + (if shower_ghost_member_drop then { shower_ghost_member_drop: true } else {})
              + (if shower_ghost_overlap_frac != null then { shower_ghost_overlap_frac: shower_ghost_overlap_frac } else {})
              + (if shower_ghost_dqdx_ratio != null then { shower_ghost_dqdx_ratio: shower_ghost_dqdx_ratio } else {})
              + (if shower_ghost_min_len != null then { shower_ghost_min_len: shower_ghost_min_len } else {})
              // doc pr/99 round 3.  C++ defaults false/0/... = legacy; keys
              // suppressed when off/null => byte-identical pre-round-3 config.
              + (if kine_charge_dedup then { kine_charge_dedup: true } else {})
              + (if kine_charge_rebuild then { kine_charge_rebuild: true } else {})
              // doc pr/101 Enu accounting round (K1-K5).  C++ defaults
              // false/0/null = legacy; keys suppressed => byte-identical.
              + (if kine_charge_track_ctx then { kine_charge_track_ctx: true } else {})
              + (if kine_mass_rules then { kine_mass_rules: true } else {})
              + (if kine_hadronic_dqdx then { kine_hadronic_dqdx: true } else {})
              + (if kine_long_muon_mode != null then { kine_long_muon_mode: kine_long_muon_mode } else {})
              + (if kine_long_muon_ratio_lo != null then { kine_long_muon_ratio_lo: kine_long_muon_ratio_lo } else {})
              + (if kine_long_muon_ratio_hi != null then { kine_long_muon_ratio_hi: kine_long_muon_ratio_hi } else {})
              + (if kine_mainvtx_used_guard then { kine_mainvtx_used_guard: true } else {})
              + (if shower_hadronic_tag then { shower_hadronic_tag: true } else {})
              + (if shower_hadronic_min_len != null then { shower_hadronic_min_len: shower_hadronic_min_len } else {})
              + (if shower_hadronic_scan_len != null then { shower_hadronic_scan_len: shower_hadronic_scan_len } else {})
              + (if shower_hadronic_bin != null then { shower_hadronic_bin: shower_hadronic_bin } else {})
              + (if shower_hadronic_r_cyl != null then { shower_hadronic_r_cyl: shower_hadronic_r_cyl } else {})
              + (if shower_hadronic_r_core != null then { shower_hadronic_r_core: shower_hadronic_r_core } else {})
              + (if shower_hadronic_growth_max != null then { shower_hadronic_growth_max: shower_hadronic_growth_max } else {})
              + (if shower_hadronic_growth_bragg != null then { shower_hadronic_growth_bragg: shower_hadronic_growth_bragg } else {})
              + (if shower_hadronic_bragg_ratio != null then { shower_hadronic_bragg_ratio: shower_hadronic_bragg_ratio } else {})
              + (if shower_hadronic_stem_ratio != null then { shower_hadronic_stem_ratio: shower_hadronic_stem_ratio } else {})
              + (if kine_count_orphan_tracks then { kine_count_orphan_tracks: true } else {})
              + (if kine_orphan_track_min != null then { kine_orphan_track_min: kine_orphan_track_min } else {})
              + (if straight_cont_cross_cluster then { straight_cont_cross_cluster: true } else {})
              + (if sccc_bridge_body then { sccc_bridge_body: true } else {})
              + (if sccc_max_gap != null then { sccc_max_gap: sccc_max_gap } else {})
              + (if sccc_kink_max != null then { sccc_kink_max: sccc_kink_max } else {})
              + (if sccc_gap_aligned != null then { sccc_gap_aligned: sccc_gap_aligned } else {})
              + (if sccc_kink_tight != null then { sccc_kink_tight: sccc_kink_tight } else {})
              ...
              // doc pr/90 round 2 -- R2 argmax arm-fill guard.  C++ default
              // 0 = legacy; null = key omitted => byte-identical pre-fix
              // config.  doc 77 round 1 (2026-08-24): teb_second_max removed
              // -- negative on its own motivating events (pr/90 sec 8.5),
              // superseded by teb_chain_topology below.
              ...
              // doc pr/104: main-vertex junction snap (405707/65289/66712/282072/
              // 345633-class: main vertex 2-4 cm off the multi-prong junction).
              // C++ defaults: snap false, radius 5 cm, min_arm 3 cm, min_prongs 2,
              // collinear 150 deg, fit_margin 0.5 cm, fit_rms 1.0 cm.  Keys
              // omitted when off/null => byte-identical pre-pr/104 config.
              + (if vertex_junction_snap then { vertex_junction_snap: true } else {})
              + (if vjs_radius != null then { vjs_radius: vjs_radius } else {})
              + (if vjs_min_arm != null then { vjs_min_arm: vjs_min_arm } else {})
              + (if vjs_min_prongs != null then { vjs_min_prongs: vjs_min_prongs } else {})
              + (if vjs_collinear != null then { vjs_collinear: vjs_collinear } else {})
              + (if vjs_fit_margin != null then { vjs_fit_margin: vjs_fit_margin } else {})
              + (if vjs_fit_rms != null then { vjs_fit_rms: vjs_fit_rms } else {})
              + (if vjs_override_kink_snap then { vjs_override_kink_snap: true } else {})
              + (if vjs_min_move != null then { vjs_min_move: vjs_min_move } else {})
              ...
              // doc pr/83 r3: op1-only scope radius (cm; -1 = unscoped).
              // C++ default 0 = use mvga_radius.  Key omitted when null =>
              // byte-identical.
              + (if mvga_op1_radius != null then { mvga_op1_radius: mvga_op1_radius } else {})
              // doc pr/83 r3: op1-only overlap threshold.  C++ default 0 =
              // use mvga_dup_frac.  Key omitted when null => byte-identical.
              + (if mvga_op1_dup_frac != null then { mvga_op1_dup_frac: mvga_op1_dup_frac } else {})
              // doc pr/83 r3 (class A): post-op3 duplicate-corridor pass
              // incl. created segments.  C++ default false.  Key omitted
              // when false => byte-identical.
              + (if mvga_op1_post then { mvga_op1_post: true } else {})
              // doc 77 round 1 (2026-08-24): mvga_carry_max removed -- not
              // needed, class A cleared 8/8 with it OFF (pr/83 r3 sec 8.5).
              // doc pr/83 r3 (Mechanism C): dup-audit the abandoned main
              // cluster inside swap_main_cluster.  C++ default false.  Key
              // omitted when false => byte-identical.
              + (if swap_orphan_dup_audit then { swap_orphan_dup_audit: true } else {})
              // doc pr/83 r4: projective duplicate collapse at the main
              // vertex (2-of-3 wire-view overlap + stem dQ/dx asymmetry).
              // C++ defaults 0 / 0.4; keys omitted when null =>
              // byte-identical (ratio inert while frac is off).
              + (if mvga_proj_dup_frac != null then { mvga_proj_dup_frac: mvga_proj_dup_frac } else {})
              + (if mvga_proj_dqdx_ratio != null then { mvga_proj_dqdx_ratio: mvga_proj_dqdx_ratio } else {})
              + (if mvga_proj_angle != null then { mvga_proj_angle: mvga_proj_angle } else {})
              // doc pr/99 round 2.  C++ defaults 0/false.  Key omitted when off => byte-identical pre-fix config.
              + (if mvga_ac_veto_radius != null then { mvga_ac_veto_radius: mvga_ac_veto_radius } else {})
              + (if mvga_ac_chord_max != null then { mvga_ac_chord_max: mvga_ac_chord_max } else {})
              + (if mvga_ac_no_cascade then { mvga_ac_no_cascade: true } else {})
              // doc pr/103 (SBND 18255-405707).  C++ defaults 0 / 1.0 cm.  Key omitted when off => byte-identical pre-fix config.
              + (if mvga_passthru != null then { mvga_passthru: mvga_passthru } else {})
              + (if mvga_passthru_tol != null then { mvga_passthru_tol: mvga_passthru_tol } else {})
              + (if mvga_interposed_fallback then { mvga_interposed_fallback: true } else {})
              + (if mvga_interposed_fallback_min_angle != null then { mvga_interposed_fallback_min_angle: mvga_interposed_fallback_min_angle } else {})
              + (if mvga_dup_starved_asym != null then { mvga_dup_starved_asym: mvga_dup_starved_asym } else {})
              + (if mvga_dup_starved_mip != null then { mvga_dup_starved_mip: mvga_dup_starved_mip } else {})
              + (if mvga_dup_starved_span != null then { mvga_dup_starved_span: mvga_dup_starved_span } else {})
              // doc 77 round 1 (2026-08-24): dl_vtx_swap_guard removed --
              // live A/B -36/1014 (pr/89 round 5).
              // doc pr/106 sec 10: C++ default false.  Key omitted when off => byte-identical.
              + (if dl_vtx_cloud_no_exclusion then { dl_vtx_cloud_no_exclusion: true } else {})
              // doc pr/112 sec 11: the dual chain (exclusion-free PR pass suggests the
              // neutrino vertex).  C++ defaults false / "snap" / false / 2.0 cm / true / 0.
              // Keys omitted when off/null => byte-identical.
              + (if dl_vtx_dual_chain then { dl_vtx_dual_chain: true } else {})
              + (if dual_chain_mode != null then { dual_chain_mode: dual_chain_mode } else {})
              + (if dual_chain_transfer then { dual_chain_transfer: true } else {})
              + (if dual_chain_transfer_max != null then { dual_chain_transfer_max: dual_chain_transfer_max } else {})
              + (if dual_chain_allow_cluster_swap != null then { dual_chain_allow_cluster_swap: dual_chain_allow_cluster_swap } else {})
              + (if dual_chain_vtx_weight != null then { dual_chain_vtx_weight: dual_chain_vtx_weight } else {})
              // doc pr/107: dQ/dx fit keeps every trajectory point (prototype
              // parity).  C++ default false.  Key omitted when off => byte-identical.
              + (if dqdx_fit_keep_all_points then { dqdx_fit_keep_all_points: true } else {})
              // doc 77 round 1 (2026-08-24): dl_vtx_topo_weight/_center
              // (pr/89 Arm C2, the rule-1 outgoing-prong topology term)
              // removed -- live A/B -8/1014.
              ...
              // admits a well-measured candidate below the terminal floor,
              // len_admit admits any candidate at least that long (cm).  C++
              // defaults 0 = off.  null omits the keys => byte-identical
              // pre-pr/102 config.
              + (if other_seg_keep_isolated_min_nnf != null then { other_seg_keep_isolated_min_nnf: other_seg_keep_isolated_min_nnf } else {})
              + (if other_seg_keep_isolated_len_admit != null then { other_seg_keep_isolated_len_admit: other_seg_keep_isolated_len_admit } else {})
              // doc 77 round 1 (2026-08-24): other_seg_uncover_3d (pr/102
              // P2, the 3-D uncovered-charge radius) removed -- 23 ADVERSE
              // movers, stays OFF.
