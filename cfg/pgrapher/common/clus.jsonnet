...
clustering_recovering_bundle(name="", graph_name="relaxed") :: {
        ...
        cathode_bundle_rescue(name="", beam_window_low=0.0, beam_window_high=0.0,
            ...
            data: dv_cfg + pcts_cfg + scope_cfg + {
                ...
                // tens of cm inside the other TPC.  null => C++ default 3 cm,
                // which sits in a measured gap (good merges overshoot <= 0.55 cm,
                // false ones by 33.5).  Inert unless a round-2 knob is on.
