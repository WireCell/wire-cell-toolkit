// This job inputs Uboone ROOT files (TC, etc), runs MABC, dumps to bee.
//
// It tests porting of WCP up to and including "STM tagger" functionality.
//
// This is yet another extension to a growing, incremental chain:
//   stm > steiner > qlport
//
// Use it from the corresponding bats script:
// 
// $ bats-debug -f stm clus/test/test-porting.bats
// $ ls tmp/stm/
//
// Hint: put test/scripts/ in your PATH to find bats-debug
//
...
local ub = {
    ...
    // DetectorVolumes component happens to ALSO implement IFiducial.
    // To start with, we will use it to provide that interface.
