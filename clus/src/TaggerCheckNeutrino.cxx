...
Configuration TaggerCheckNeutrino::default_configuration() const
{
    ...
    cfg["kine_sat_cont_keep_deg"]                       = m_kine_sat_cont_keep_deg;                       // deg; doc pr/146, 0 = arm C unchanged
    ...
    cfg["kine_near_pointing_impact"]                 = m_kine_near_pointing_impact;                 // doc pr/144; cm; 0 = pointing test off, byte-identical
    cfg["kine_near_pointing_miss_deg"]               = m_kine_near_pointing_miss_deg;               // doc pr/144; deg
...
void TaggerCheckNeutrino::visit(Ensemble& ensemble) const
{
    ...
    for (size_t nu_index = 0; nu_index < candidates.size(); ++nu_index) {
        ...
        pattern_algos.m_kine_sat_cont_keep_deg                       = m_kine_sat_cont_keep_deg;                       // pr/146 (degrees)
        ...
        pattern_algos.m_kine_near_pointing_impact                 = m_kine_near_pointing_impact * units::cm;     // doc pr/144
        pattern_algos.m_kine_near_pointing_miss_deg               = m_kine_near_pointing_miss_deg;               // doc pr/144
