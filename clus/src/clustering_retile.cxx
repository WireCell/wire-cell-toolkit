...
void ClusteringRetile::configure(const WireCell::Configuration& cfg)
{
...
// Step 1. Build activities from blobs in a cluster.
void ClusteringRetile::get_activity(const Cluster& cluster, std::map<std::pair<int, int>, std::vector<WRG::measure_t> >& map_slices_measures, int apa, int face) const
{
...
// Step 3. Form IBlobs from activities.
std::vector<IBlob::pointer> ClusteringRetile::make_iblobs(std::map<std::pair<int, int>, std::vector<WRG::measure_t> >& map_slices_measures, int apa, int face) const
{
...
ClusteringRetile::remove_bad_blobs(const Cluster& cluster, Cluster& shad_cluster, int tick_span, int apa, int face) const
{
