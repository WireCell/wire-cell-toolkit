...
local magoutput = 'mag_trtn_TbbFlow_conc2.root';
...
local plugins = [ "WireCellSio", "WireCellGen", "WireCellSigProc","WireCellApps", "WireCellPgraph", "WireCellTbb", "WireCellRoot", "WireCellHio", "WireCellPytorch", "WireCellTriton"];

// Pgrapher or TbbFlow
local engine = "TbbFlow"; //"Pgrapher";
local app = {
  type: 'TbbFlow', //'Pgrapher',
  data: {
    edges: g.edges(graph),
  },
};
