...
namespace WireCell {
	...
	namespace Microboone {
	    ...
	    bool Subtract_WScaling(WireCell::IChannelFilter::channel_signals_t& chansig, const WireCell::Waveform::realseq_t& medians, const WireCell::Waveform::compseq_t& respec, int res_offset, std::vector< std::vector<int> >& rois, std::map<int,std::vector< std::vector<int> >>& chgr_rois, float upper_decon_limit1=0.08, float roi_min_max_ratio=0.8);
