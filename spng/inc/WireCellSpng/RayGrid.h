...
namespace WireCell::SPNG::RayGrid {
    ...
    public:
        ...
        /**
         * Like point_pitches() but only one view.
         *
         */
        torch::Tensor point_pitches(const torch::Tensor& points, int view) const;
         ...
         */
        torch::Tensor point_indices(const torch::Tensor& points, Rounding rd = Rounding::kFloor) const;

        /**
         * Like point_indices but only one view.
         */
        torch::Tensor point_indices(const torch::Tensor& points, int view, Rounding rd = Rounding::kFloor) const;
