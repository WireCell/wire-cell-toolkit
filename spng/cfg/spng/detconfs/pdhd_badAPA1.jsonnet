...
local fr_apa1 = api.fields_from_name(detname, index=1); #Index 1 corresponds to Bad APA1 see wire-cell-data detectors.jsonnet
local fr_other = api.fields_from_name(detname, index=0);
...
local tpcs = [
    ...
    api.tpc(anode, lar=lar, ductor=ductor, splat=splat, adc=adc, fr=this_fr, er=er_spng,
